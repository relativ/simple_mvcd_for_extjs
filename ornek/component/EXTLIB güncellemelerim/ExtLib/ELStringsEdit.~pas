...
var
  SELStringsEditorDlgCaption: string              = 'Yazý Editörü';
  SELStringsEditorDlgOkBtnCaption: string         = '&Tamam';
  SELStringsEditorDlgCancelBtnCaption: string     = 'Ýptal';
  SELStringsEditorDlgLinesCountTemplate: string   = '%d satýr';
