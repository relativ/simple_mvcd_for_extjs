...
type
  ...
  private
    ...
    function IndexOfEditor(AEditorClass: TELPropEditorClass): Integer;
  ...
  public
    ...
    procedure UnregisterPropEditor(AEditorClass: TELPropEditorClass);
...
begin
  Result := (AX >= ColWidths[0] - 2) and (AX <= ColWidths[0]);
end;
...
begin
  ...
  begin
    ...
    try
      ...
      R := Rect(1, 1, Width - 2 - ButtonWidth * Ord(EditStyle <> esSimple), Height + 1);
...
procedure TELCustomPropertyInspector.UnregisterPropEditor(
  AEditorClass: TELPropEditorClass);
var
  LI, LJ: Integer;
begin
...
function TELCustomPropertyInspector.IndexOfEditor(
...
begin
  ...
  for LI := 0 to High(FEditors) do
    if FEditors[LI].EditorClass = AEditorClass then
    begin
      Result := LI;
      Break;
    end;
