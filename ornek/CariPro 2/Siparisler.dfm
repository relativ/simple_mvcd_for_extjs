object FSiparisler: TFSiparisler
  Left = 238
  Top = 159
    ...
    object Panel3: TPanel
      ...
      object GroupBox1: TGroupBox
        ...
        object OnlineDBGrid2: TTechDBGrid
          ...
          Align = alClient
          BorderStyle = bsNone
          DataSource = DMSiparis.SiparislerDS
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
  ...
  object PopupMenu1: TPopupMenu
    ...
    object Busipariialaevir1: TMenuItem
      Caption = 'Bu sipari'#351'i al'#305#351'a '#231'evir'
      OnClick = Busipariialaevir1Click
    end
    object Busipariisataevir1: TMenuItem
      Caption = 'Bu sipari'#351'i sat'#305#351'a '#231'evir'
      OnClick = Busipariisataevir1Click
    end
    object Busipariigiriirsaliyesineevir1: TMenuItem
      Caption = 'Bu sipari'#351'i giri'#351' irsaliyesine '#231'evir'
      OnClick = Busipariigiriirsaliyesineevir1Click
    end
    object Busipariikirsaliyesineevir1: TMenuItem
      Caption = 'Bu sipari'#351'i '#231#305'k'#305#351' irsaliyesine '#231'evir'
      OnClick = Busipariikirsaliyesineevir1Click
    end
    object BuSipariiSipariVer1: TMenuItem
      Caption = 'Bu Sipari'#351'i Sipari'#351' Ver'
    end
    object N1: TMenuItem
      Caption = '-'
    end
