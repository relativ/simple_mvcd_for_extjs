object FNakitYatirma: TFNakitYatirma
  Left = 566
  Top = 263
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsToolWindow
  Caption = 'Bankaya Nakit Yat'#305'rma'
  ClientHeight = 365
  ClientWidth = 325
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Panel5: TPanel
      ...
      object YeniNakitYatir: TTechButton
        Left = 81
        Top = 33
        Width = 75
        Height = 25
    ...
    object Panel6: TPanel
      ...
      object DBEdit1: TDBTechEdit
        ...
        DataSource = DMBanka.NakitYatirmaDS
        ReadOnly = True
        TabOrder = 0
        RenkGiris = clAqua
        RenkCikis = clInfoBk
